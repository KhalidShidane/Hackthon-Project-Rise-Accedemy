  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-3xl bg-[#2C65F4] px-7 py-12 text-center text-white sm:px-12 md:py-16">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link to="/signup" className="rounded-lg bg-white px-6 py-3 text-sm font-semibold text-[#2C65F4] transition hover:bg-blue-50">
              Create a Profile
            </Link>
