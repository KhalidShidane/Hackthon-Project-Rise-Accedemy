      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-6">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          {user ? (
            ...
            <Link to="/login" className="ml-2 px-3 py-2 text-sm font-semibold text-slate-700 hover:text-blue-800">Login</Link>
            <Link to="/signup" className="rounded-lg bg-[#3263E8] px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-800">Sign Up</Link>
          </>}
        </div>
